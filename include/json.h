/*
	THIS IS A CUSTOM JSON PARSER.
		- it is taylor on the database needs.
		I am sure that this is not the best parser there is, for one, I am using regex in C,
		which I know that the regex library is allocating memory under the hood and this is
		increase the overhead of this software.
		since this is a free software where from hee you can build a product and sell it, we can make this
		JSON parser better for sure!
		reach me out at piombinilorenzo1987@gmail.com
...
#define JSRGX_OBJECT "\\{\\s*" JSRGX_STRING ":\\s*(" JSRGX_STRING "|" JSRGX_VALUE "|" JSRGX_ARRAY "|" JSRGX_NESTED_ARRAY ")" \
					 "(,\\s*" JSRGX_STRING ":\\s*(" JSRGX_STRING "|" JSRGX_VALUE "|" JSRGX_ARRAY "|" JSRGX_NESTED_ARRAY "))*\\s*\\}"

#define JSRGX_NESTED_OBJECT "\\{\\s*" JSRGX_STRING ":\\s*(" JSRGX_STRING "|" JSRGX_VALUE "|" JSRGX_ARRAY "|" JSRGX_NESTED_ARRAY "|" JSRGX_OBJECT ")(,\\s*" JSRGX_STRING ":\\s*(" JSRGX_STRING "|" JSRGX_VALUE "|" JSRGX_ARRAY "|" JSRGX_NESTED_ARRAY "|" JSRGX_OBJECT "))*\\s*\\}"

#define JSRGX_NST_OBJ_LAST "\\{\\s*" JSRGX_STRING ":\\s*(" JSRGX_STRING "|" JSRGX_VALUE "|" JSRGX_ARRAY "|" JSRGX_NESTED_ARRAY "|" JSRGX_OBJECT "|" JSRGX_NESTED_OBJECT ")(" \
						   ",\\s*" JSRGX_STRING ":\\s*(" JSRGX_STRING "|" JSRGX_NESTED_OBJECT "|" JSRGX_VALUE "|" JSRGX_ARRAY "|" JSRGX_NESTED_ARRAY "|" JSRGX_OBJECT "))*\\s*\\}"
...
#define JSRGX_NESTED_OBJECT_W_ARRAY_W_OBJ "\\{\\s*" JSRGX_STRING ":\\s*(" JSRGX_STRING "|" JSRGX_VALUE                                                                       \
										  "|" JSRGX_ARRAY "|" JSRGX_NESTED_ARRAY "|" JSRGX_OBJECT "|" JSRGX_ARRAY_WITH_OBJECT "|" JSRGX_NESTED_OBJECT ")(,\\s*" JSRGX_STRING \
...
#define JSRGX_OBJ "^\\{\\s*" JSRGX_STRING ":\\s*(" JSRGX_OBJECT "|" JSRGX_STRING "|" JSRGX_VALUE                                                                          \
				  "|" JSRGX_ARRAY "|" JSRGX_NESTED_ARRAY "|" JSRGX_NESTED_OBJECT "|" JSRGX_ARRAY_WITH_OBJECT "|" JSRGX_NESTED_OBJECT_W_ARRAY_W_OBJ ")(,\\s*" JSRGX_STRING \
